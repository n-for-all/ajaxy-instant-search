...
if (isset($_POST['sf_rsubmit']) && wp_verify_nonce($_POST['_wpnonce'])) {
    ...
    $AjaxyLiveSearch->set_style_setting('results_width_unit', $styles['results_width_unit'] ?? 'px');
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="checkbox" name="sf[style][rtl]" <?php echo  $AjaxyLiveSearch->get_style_setting('rtl_theme', 1) > 0 ? 'checked="checked"' : ''; ?> />
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('width', 180); ?>" name="sf[style][width]" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('expand', false); ?>" name="sf[style][expand]" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('delay', 500); ?>" name="sf[style][delay]" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('border-width', 1); ?>" name="sf[style][b_width]" class="regular-text">
        ...
        <table class="form-table">
            <tbody>
                <tr valign="top">
                    <th scope="row"><label><?php _e('Width'); ?></label></th>
                    <td>
                        <input style="width:90px" type="number" value="<?php echo  $AjaxyLiveSearch->get_style_setting('results_width', 315); ?>" name="sf[style][results_width]" class="regular-text">
                        <select name="sf[style][results_width_unit]">
                            <option value="px" <?php echo ($AjaxyLiveSearch->get_style_setting('results_width_unit',  'px') == 'px' ? 'selected="selected"' : ""); ?>><?php _e('Pixels'); ?></option>
                            <option value="%" <?php echo ($AjaxyLiveSearch->get_style_setting('results_width_unit') == '%' ? 'selected="selected"' : ""); ?>><?php _e('Percent'); ?></option>
                        </select>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('excerpt', 10); ?>" name="sf[style][excerpt]" class="regular-text">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('thumb_height', 50); ?>" name="sf[style][thumb_height]" class="regular-text">
                        <label><?php _e('X width'); ?></label>
                        <input style="width:90px" type="text" value="<?php echo  $AjaxyLiveSearch->get_style_setting('thumb_width', 50); ?>" name="sf[style][thumb_width]" class="regular-text">
